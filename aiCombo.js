...
// Simple language detection fallback (no external dependency)
...
(async () => {
  ...
  const { useSameDevice, customDevice, enableSchedule, startHour, endHour, username, password, source, target, hashtag, mode, jumlah, minDelay, maxDelay } = await inquirer.prompt([
